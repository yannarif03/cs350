...
for i in {1..10}; do
    mid="${mid}0:r:1:0,0:r:1:1,0:r:1:2,0:r:1:3,0:r:1:4,0:r:1:5,0:r:1:6,0:r:1:7,0:r:1:8,0:r:1:9,\
...
0:h:1:0,0:h:1:1,0:h:1:2,0:h:1:3,0:h:1:4,0:h:1:5,0:h:1:6,0:h:1:7,0:h:1:8,0:h:1:9,"
    ...
    if [[ $i = 5 ]] || [[ $i = 10 ]]
    then
    /usr/bin/time -v ../build/server_mimg -q 1500 -w 10 -p FIFO 2222 2>&1 > /dev/null | grep "wall clock" > c_$i\_out.txt & ../client 2222 -I ../images_all/ -L $intro$mid$outro
    fi
